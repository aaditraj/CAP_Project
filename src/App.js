    ...
    this.setState({
      ...
      this.setState({
        ...
        this.setState({
          ...
          this.setState({
            trueFalseCorrect: (this.state.trueFalseText === await this.truefalseData.Answer ? 1: 0),
          }, async() => {
            this.setState({
              fillBlankCorrect: (this.state.fillBlankText === await this.fillBlankData.Answer ? 1 : 0),
              submitted: true
            })
          })
        })
